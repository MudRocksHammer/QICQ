...
public:
    ...
    static QString m_strSoundPath;          //音频文件目录
    static QString m_strRecordPath;         //录音目录

    static QString m_strFacePath;           //
    static QString m_strHeadPath;           //
    ...
    static QString m_strPassword;           //密码
    ...
    //=========================函数功能部分==========================//
    static void InitApp(const QString& appPath);        //初始化APP
    static void CreateSettingFile();                    //创建配置文件
    static void ReadSettingFile();                      //读配置文件，加载配置系统
